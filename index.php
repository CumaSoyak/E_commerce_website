            ...
            <div class="col-12">
                <div class="product_tab_button">
                    <ul class="nav" role="tablist">
                        ...
                        <li>
                            <a data-toggle="tab" href="#OnSale" role="tab" aria-controls="OnSale" aria-selected="false">
                                OnSale</a>
                        </li>
                        <li>
                ...
                <div class="row">
                    <div class="product_active owl-carousel">
                            ...
                            <div class="single_product">
                                ...
                                <div class="product_content">
                                    ...
                                    <div class="product_action">
                                        <ul>
                                            <li class="product_cart"><a href="#" title="Add to Cart">Add to Cart</a>
                                            </li>
                        ...
                        <div class="col-lg-3">
                            <div class="single_product">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="assets/img/product/product7.jpg"
                                                                        alt=""></a>
                                    <div class="btn_quickview">
                                        <a href="#" data-toggle="modal" data-target="#modal_box" title="Quick View"><i
                                                    class="ion-ios-eye"></i></a>
